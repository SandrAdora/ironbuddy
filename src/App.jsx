...
import { userUser } from './context/userContext.jsx';
...
export default function OnboardingForm() {
  ...
  <h1 className="text-4xl md:text-5xl font-black italic uppercase leading-tight tracking-tighter">
    {/* Haupt-Glow auf dem Namen */}
    <span className="text-white">Hello, I am </span>
    <span className="text-[--color-iron-gold] drop-shadow-[0_0_10px_rgba(250,204,21,0.8)] animate-pulse">
      🤖 {AIname}
    </span>
    <br />
    <span className="text-white/90 text-3xl md:text-4xl mt-2 block">
      Your Fitness Trainer
    </span>
  </h1>

  <p className="text-gray-400 text-lg max-w-xl leading-relaxed border-l-2 border-[--color-iron-gold]/30 pl-4">
    I am here to train with you for as long as you keep going. 
    <span className="text-white font-bold"> Let's get started</span> – I need to know your vitals to build your 
    <span className="text-[--color-iron-gold] opacity-90"> custom protocol.</span>
  </p>
</div>
